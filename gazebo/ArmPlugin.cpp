...
bool ArmPlugin::createAgent()
{
        ...
        */
        ...
        agent = dqnAgent::Create(INPUT_WIDTH, INPUT_HEIGHT, INPUT_CHANNELS, NUM_ACCTIONS,
...
//                bool checkGroundContact = (gripBBox.max.z <= groundContact || gripBBox.min.z <= groundContact) ? true : false;
